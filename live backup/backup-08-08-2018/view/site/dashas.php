...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
 <style type="text/css">
        .fa-angle-down  { width: 18px; height: 18px; border-radius: 50%; text-align: center; line-height: 1.4;   vertical-align: middle; border: 1px solid #c6c6c6; font-size: 13px; margin-right: 20px;}
        .fa-angle-right { width: 18px; height: 18px; border-radius: 50%; text-align: center; line-height: 1.4; vertical-align: middle; border: 1px solid #c6c6c6; font-size: 13px; background-color: #dcdcdc; margin-right: 20px;}
        ...
        @media screen and (max-width:768px) {
            ...
            .fa-angle-down  { width: 14px; height: 14px; border-radius: 50%; text-align: center; line-height: 1.4;   vertical-align: middle; border: 1px solid #c6c6c6; font-size: 10px;}
        .fa-angle-right { width: 14px; height: 14px; border-radius: 50%; text-align: center; line-height: 1.4; vertical-align: middle; border: 1px solid #c6c6c6; font-size: 10px; background-color: #dcdcdc;}
        }
    </style>
</head>
    <body>
        <div class="container">
            <div class="row rasitable">
                ...
                <ul class="parent" id="newparent<?= $i+1 ?>">
                    <li class="<?= $class ?> ?>"><i class="fa fa-angle-right arrow parentclick" aria-hidden="true" parentprop="1" parentdays="<?= $finalAry[$i]['nofDays'] ?>" fromdate="<?= $finalAry[$i]['from_date'] ?>" newparent="<?= $i+1 ?>" id="clciknewparentid<?= $i+1 ?>" planetname="<?= $finalAry[$i]['planet']; ?>" ></i><?= $finalAry[$i]['planet'] ?></li>
