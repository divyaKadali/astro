...
<div class="box-body">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->g_indId], ['class' => 'btn btn-primary']) ?>
        <?php  Html::a('Delete', ['delete', 'id' => $model->g_indId], [
...
//             ],
    ...
    <div class="row">
    <div class="col-sm-4" ><a>Gochaara Position Id</a></div>
    <div class="col-sm-4" >:</div>
    <div class="col-sm-4" ><?= $model->g_positionid; ?></div></li>
    </div></br>
    <div class="row">
    ...
    <div class="col-sm-4" ><?= $model->mercury ?></div></li>
     ...
     <div class="row">
    <div class="col-sm-4" ><a>Jupitor </a></div>
    <div class="col-sm-4" >:</div>
