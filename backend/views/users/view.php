...
<div class="box-body">
    ...
    <div class="col-sm-4" ><?= $userdetailview->mobile; ?></div></li>
     ...
     <div class="row">
    <div class="col-sm-4" ><a>Address </a></div>
    <div class="col-sm-4" >:</div>
    <div class="col-sm-4" ><?= $userdetailview->address; ?></div></li>
    </div></br>
     <div class="row">
    <div class="col-sm-4" ><a>Remedies </a></div>
    <div class="col-sm-4" >:</div>
    <div class="col-sm-4" ><?= $userdetailview->remedies; ?></div></li>
    </div></br>
     <div class="row">
