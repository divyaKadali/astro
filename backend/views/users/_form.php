...
<div class="users-form">
    ...
    <?php }else{
    ?>
     <div class="col-md-3"><?= $form->field($model, 'username')->textInput(['maxlength' => true, 'readOnly'=>true]) ?></div>
    <div class="col-md-3"><?= $form->field($model, 'email')->textInput(['maxlength' => true , 'readOnly'=>true]) ?></div>
    <div class="col-md-3"><?= $form->field($model, 'dateofbirth')->widget(DatePicker::classname(), [
    'options' => ['placeholder' => 'Enter birth date'],
    'pluginOptions' => [
        'autoclose'=>true,
...
<div class="col-md-3"><?= $form->field($model, 'timeofbirth')->widget(TimePicker::classname(), [
    ...
    <div class="col-md-3"><?= $form->field($model, 'address')->textarea(['maxlength' => true]) ?></div>
    <div class="col-md-3"><?= $form->field($model, 'status')->dropDownList(['10' => 'Active','0' => 'In-active'],['prompt' => 'Select Status']) ?></div>
    <div class="col-sm-3"><?= $form->field($model, 'remedies')->textarea(['maxlength' => true]) ?></div>
