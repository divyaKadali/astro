...
?>
<div class="planet-transistion-view">
...
<div class="box-body">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->planetTransId], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->planetTransId], [
    ...
    <div class="col-sm-3" >:</div>
    <div class="col-sm-4" ><?= $model->jupitar; ?></div></li>
    </div></br>
    <div class="row">
    ...
    <div class="col-sm-3" >:</div>
    <div class="col-sm-4" ><?= $model->saturan; ?></div></li>
    </div></br>
    <div class="row">
